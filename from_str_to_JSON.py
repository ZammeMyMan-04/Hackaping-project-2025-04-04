...
# Input data (shortened example — replace this with the full raw string if running locally)
data = """
...
for line in data.splitlines():
    ...
    elif match := re.match(r"^(\S+)\s{2,}(.*)", line):
...
# Save to JSON
output_path = os.path.expanduser("~/Programmering/ai_test/git_commands.json")
